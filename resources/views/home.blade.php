      ...
      <div class="col-lg-8 col-12 custom-padding-right">
        <div class="slider-head">
          <div class="hero-slider">
            ...
            <div class="single-slider" style="background-image: url({{ asset('/') }}images/hero/{{ $product->image }});">
              <div class="content">
                <h2><span>Siêu giảm giá 50%</span>
                  {{ $product->name }}
                </h2>
                <p>{{ $product->description }}</p>
                <h3><span>Now Only</span> ${{ $product->price }}</h3>
                <div class="button">
                  <a href="{{ url('/detail/' . $product->id) }}" class="btn">Shop Now</a>
                </div>
      ...
      <div class="col-lg-4 col-12">
        <div class="row">
          <div class="col-lg-12 col-md-6 col-12 md-custom-padding">
            <!-- Start Small Banner -->
            <a style="display: block" href="{{ url('/detail/' . $oldProduct->id) }}">
              <div class="hero-small-banner" style="background-image: url('{{ asset('/') }}images/hero/{{ $oldProduct->image }}');">
                <div class="content">
                  <h2>
                    <span>New line required</span>
                    {{ $oldProduct->name }}
                  </h2>
                  <h3>${{ $oldProduct->price }}</h3>
                </div>
              </div>
            </a>
            <!-- End Small Banner -->
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-6 col-12">
        ...
        <div class="single-category">
          ...
          <ul>
            <li><a href="product-grids.html">{{ $category->name }} Item 1</a></li>
            <li><a href="product-grids.html">{{ $category->name }} Item 2</a></li>
            <li><a href="product-grids.html">{{ $category->name }} Item 3</a></li>
            <li><a href="product-grids.html">{{ $category->name }} Item 4</a></li>
            <li><a href="product-grids.html">View All</a></li>
          </ul>
          <div class="images">
            @if ($category->products->isNotEmpty())
            <img src="{{ asset($category->products->random()->image) }}" alt="{{ $category->name }}" width="201" height="204">
            <p>ID: {{ $category->products->random()->id }}</p>
            @else
            <img src="{{ asset('images/featured-categories/default-image.png') }}" alt="No Image" width="201" height="204">
            @endif
          </div>
        </div>
        <!-- End Single Category -->
